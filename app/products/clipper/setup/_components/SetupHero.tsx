...
export function SetupHero({
  ...
  return (
    <section className={`${BLOCK} relative overflow-hidden bg-[#191919] text-white px-4 pt-4 pb-10 sm:px-8 sm:pt-6 sm:pb-14 lg:px-12`}>
      <LogoWatermark className="-right-16 -bottom-24 w-[240px] text-white/[0.05] sm:-right-20 sm:w-[340px]" />
      {/* Pill brand — link balik ke halaman produk */}
      <div className="relative flex items-center justify-between gap-3 rounded-full bg-white/10 backdrop-blur border border-white/15 py-2.5 px-5">
      ...
      <div className="relative mx-auto max-w-3xl flex flex-col items-start gap-5 pt-10 sm:pt-14">
